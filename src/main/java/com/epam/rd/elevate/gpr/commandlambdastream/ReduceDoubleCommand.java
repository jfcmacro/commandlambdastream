...
public class ReduceDoubleCommand implements GetDoubleSetListSalesSummaryRowCommand {
    ...
    public ReduceDoubleCommand(GetDoubleSetSalesSummaryRowCommand doubleSalesSummaryRowCommand,
